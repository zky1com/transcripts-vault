---
title: "Science Is the Engine That Pulls Humanity Forward"
people_mentioned: []
channel: "Naval"
video_id: "PMZkf_Z4Q58"
url: "https://www.youtube.com/watch?v=PMZkf_Z4Q58"
...
Naval frames science as the primary force behind long-run improvement in human life. His point is that scientific progress has become so familiar that many people now take it for granted, even while misunderstanding what science actually is and allowing the word to be used as a badge of authority rather than a method of truth-seeking.

## Key Insights

- Science deserves respect because it has repeatedly improved material life, not because institutions declare it sacred.
- "Believe in science" is a category error because science is not meant to be accepted as dogma.
- Many people admire science socially while lacking a clear model of how scientific theories are actually formed.
- The concept of science is vulnerable to political and institutional hijacking when people confuse it with expert branding.
- Naval treats the philosophy of science as foundational because misunderstanding it distorts how societies judge truth.
...
- [[Naval - Believe in science is an oxymoron — science is a method of truth-seeking that must be questioned not a body of authority accepted on faith]]
