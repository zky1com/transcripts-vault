---
title: "ItÃ¢â‚¬â„¢s Rare to Have Competing, Viable, Scientific Theories"
people_mentioned: []
channel: "Naval"
video_id: "2e3TNW5y9qw"
url: "https://www.youtube.com/watch?v=2e3TNW5y9qw"
...
Naval argues that people overestimate the role of Bayesian updating in real discovery. Bayesian methods are powerful once a finite hypothesis space already exists, but the genuinely hard part of science is producing new explanations in the first place, and that part comes from creativity rather than probability math.

## Key Insights

- Science rarely has many equally viable competing theories at once.
- Bayesianism is excellent for updating within a known menu of options.
- Creativity is what generates new candidate explanations before any updating can happen.
- The methods for judging explanations are criticism and experiment, not just formal prior revision.
- Confusing probability updating with theory creation leads to a shallow picture of scientific progress.
